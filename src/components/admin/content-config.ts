...
const contentConfigs: Record<ContentTypeKey, ContentConfig> = {
  blog: {
    ...
    label: '文章管理',
    navLabel: 'Blog',
    description: '管理 Blog 文章、草稿、摘要与发布状态。',
    mode: 'collection',
    supportsAssets: true,
    ...
    fields: [
      ...
      { key: 'layout', label: '页面布局', kind: 'text', placeholder: 'PostLayout' },
  ...
  profile: {
    ...
    bodyField: 'body',
    fields: [
      { key: 'name', label: '姓名', kind: 'text', placeholder: '陈富东' },
      {
        key: 'headline',
        label: '标题',
        kind: 'text',
        placeholder: 'AI 产品经理 ｜ 开发者 ｜ 创业者',
      },
      { key: 'avatar', label: '头像', kind: 'text', placeholder: '/static/images/avatar.png' },
      { key: 'updatedAt', label: '更新时间', kind: 'datetime-local' },
      { key: 'company', label: '公司', kind: 'text', placeholder: 'GoGeek' },
      { key: 'email', label: '邮箱', kind: 'text', placeholder: 'name@example.com' },
      { key: 'location', label: '所在地', kind: 'text', placeholder: 'BeiHai, China' },
      ...
      { key: 'skills', label: '技能标签', kind: 'comma-list', placeholder: '产品设计, 全栈开发' },
